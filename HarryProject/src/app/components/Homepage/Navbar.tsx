    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          {/* Categories and Search (kept active, not commented) */}
          ...
          <div className="flex items-center space-x-8">
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/sign-up" className="font-medium">SIGN UP</Link>
              <Link href="/log-in" className="font-medium">LOG IN</Link>
              <Link href="/admin/login" className="font-medium">ADMIN</Link>
            </div>
