...
const slides = [
  {
    title: <> {/* <span className="text-green-500">Organic</span> Foods at your Doorsteps */} </>,
    subtitle: "",
    image: "/homePage/slide4.jpg",
  },
  {
    title: <> {/* <span className="text-green-500">Healthy</span> Food, Healthy Lifestyle */} </>,
    subtitle: "",
    image: "/homePage/candle-slide.jpg",
    bgColor: "bg-[#FFF3E0]",
  },
  {
    title: <> {/* <span className="text-green-500">Fresh</span> Veggies Daily Delivery */} </>,
    subtitle: "",
